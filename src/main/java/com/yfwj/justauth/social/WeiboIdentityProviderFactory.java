...
public class WeiboIdentityProviderFactory extends
  ...
  public JustIdentityProvider create(KeycloakSession session, IdentityProviderModel model) {
    return new JustIdentityProvider(session, new JustIdentityProviderConfig(model, JUST_AUTH_KEY, "fa fa-weibo"));
  }
